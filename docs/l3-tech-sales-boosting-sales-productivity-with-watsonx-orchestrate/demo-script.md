...
| **Action** &nbsp; 3.2 | Select the **Automations** tab **(A)**, then enter the unique reference **“XXddmmyy”** that corresponds to your decision model in the **search** field **(B)** and press **Enter**, then click on the tile that corresponds to your automation **(C)**.<br/><img src="images/Script-3-2.png" width="800" /> |
